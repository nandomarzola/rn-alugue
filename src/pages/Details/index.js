  ...
  return (
    <View style={styles.container}>
       ...
       <View style={styles.headerContent}>
          ...
          <View style={{width: '35%'}}> 
          <Text style={styles.rating}>Avaliaçoes</Text>
         ...
         <Text style={styles.description}>
            Casa nova pertinho da praia, é só chegar e chapar
         </Text>

        <ScrollView horizontal showsHorizontalScrollIndicato={false} style={{paddingHorizontal:15,  marginTop:35}}>
